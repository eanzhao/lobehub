export default {
  ...
  'channel.comingSoonDesc':
    'We are working on bringing this integration to Aevatar. Stay tuned for updates.',
  ...
  'channel.messengerPromo.desc': 'No bot setup. Chat with Aevatar on Slack, Discord, Telegram.',
