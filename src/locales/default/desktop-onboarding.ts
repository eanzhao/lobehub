export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using Aevatar Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Aevatar. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Aevatar',
  ...
  'screen5.actions.signInCloud': 'Sign in to Aevatar Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Aevatar Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Aevatar Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Aevatar server instance',
