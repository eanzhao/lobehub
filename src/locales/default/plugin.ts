export default {
  ...
  'protocolInstall.official.badge': 'Aevatar Official Skill',
  'protocolInstall.official.description': 'Official Aevatar Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. Aevatar does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
