export default {
  ...
  'createGuide.func1.title': 'Submit in Aevatar',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Aevatar Community.',
  'footer.title': 'Share your creation on Aevatar Community today',
  ...
  'models.providerInfo.apiTooltip': 'Aevatar supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Aevatar Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by Aevatar automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the Aevatar marketplace with one click.',
