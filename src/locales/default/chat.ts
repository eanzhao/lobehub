export default {
  ...
  'claudeCodeInstallGuide.reason': 'Aevatar could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'Aevatar could not start Codex: {{message}}',
  ...
  'plus.search.appSearchDesc':
    'Aevatar optimized search service, delivering best retrieval results.',
  ...
  'sharePageDisclaimer':
    'This content is shared by a user and does not represent the views of Aevatar. Aevatar is not responsible for any consequences arising from this shared content.',
