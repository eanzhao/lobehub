export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Aevatar server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Aevatar Cloud',
